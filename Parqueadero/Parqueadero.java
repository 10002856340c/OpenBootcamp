                                ...
                                if (atributos.A <= 4) {
                                        ...
                                        switch (atributos.A) {
                                                case 1: {
                                                        ...
                                                        System.out.println(
                                                                        "||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||-DATOS DEL CARRO No. --> "
                                                                                        ...
                                                                                        + "\n");
                                                        System.out.println(
                                                                        "*) La entrada del carro No. --> "
                                                                                        + atributos.cuentaCarros
                                                                                        + " es : " +
                                                                                        atributos.HoraEntradaCarro
                                                                                        + " : ");
                                                        System.out.println(
                                                                        "*) La Salida del carro No. -->  "
                                                                                        + atributos.cuentaCarros
                                                                                        + " es : " +
                                                                                        atributos.HoraSalidaCarro);
                                                        atributos.HorasCarros = Integer
                                                                        .valueOf(atributos.HoraSalidaCarro)
                                                                        - Integer.valueOf(atributos.HoraEntradaCarro);
                                                        atributos.ConversionHorasCarros = atributos.HorasCarros * 60;
                                                        atributos.TotalPagarCarros = atributos.ConversionHorasCarros
                                                                        * 60;
                                                        System.out.println(
                                                ...
                                                case 2: {
                                                        ...
                                                        System.out.println(
                                                                        "*) El total a pagar de la Moto No. --> "
                                                                                        ...
                                                                                        + " COP"
                                                                                        + "\n");
                                                        atributos.sumaTOTALMotos = atributos.sumaTOTALMotos
                                                                        + atributos.TotalPagarMotos;
                                                ...
                                                case 3: {
                                                        ...
                                                        System.out.println(
                                                                        "Ingrese el numero de documento de la Bicicleta :");
                                                        ...
                                                        atributos.HorasBicicletas = Integer
                                                                        .valueOf(atributos.HoraSalidaBicicleta)
                                                                        - Integer.valueOf(
                                                                                        atributos.HoraEntradaBicicleta);
                                                        atributos.ConversionHorasBicicletas = atributos.HorasBicicletas
                                                                        * 60;
                                                        atributos.TotalPagarBicicletas = atributos.ConversionHorasBicicletas
                                                                        * 20;
                                                        System.out.println(
                                        ...
                                        System.out.println("Ingrese datos que estan dentro del menu :");
                                        IniciarSistemaParqueo();
                                }
